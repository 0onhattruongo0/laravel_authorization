...
<form action="{{route('admin.users.postAdd')}}" method="POST" class="">
@csrf
<div class='mb-3'>
    <label for="">Tên</label>
    <input type="text" name='name'  class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder = 'Tên...'>
    @error('name')
